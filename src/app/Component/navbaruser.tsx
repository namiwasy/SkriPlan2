    ...
    <div>
      ...
      <div className='font-poppins flex flex-row ml-auto mr-10 items-center justify-center text-white font-bold'>
        <div className='flex items-center space-x-2'>
          ...
          onClick={() => router.push("/Skriplan/User/Akunuser")} />
          <a href="/Skriplan/User/Akunuser" className='text-xl font-medium hover:text-[#1E3E62] hover:scale-110 transition-all duration-400 cursor-pointer'>Username</a>
        </div>
        <img 
